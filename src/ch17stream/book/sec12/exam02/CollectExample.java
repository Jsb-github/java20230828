...
public class CollectExample {
    public static void main(String[] args) {
        ...
        maleList.forEach(s-> System.out.println(
                s.getName()
        ));

        System.out.println();
        map.get("남").forEach(s-> System.out.println(
                s.getName()
        ));
        ...
        femaleList.forEach(s-> System.out.println(
                s.getName()
        ));
        ...
        //
        System.out.println();
        map.get("여").forEach(s-> System.out.println(
                s.getName()
        ));
